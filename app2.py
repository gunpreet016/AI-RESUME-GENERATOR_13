...
user will upload data and return html format resume make it diffrent colour scheme andthe resume should project m skill set  
also make it look like professional , create side margins table also make the text gradient for heddings like professional summary, Include ONLY these sections:
...
2. Professional Summary
   - Write a concise summary in 3-4 lines.

3. Experience
   - Show work experience or internships.
   - If no experience is provided, create a short "Academic Projects" section instead.

4. Technical Skills
   - Display skills in a clean badge/grid layout.
   all these informstion should be in short not too long
...
USER_INFO=st.text_input("Name: Gunpreet kaur, ✉️: gunpreetkaur016@gmail.com, 📱: 9315995109,📍Delhi| India")
